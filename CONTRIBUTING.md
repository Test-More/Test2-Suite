...
https://metacpan.org/release/Test2-Suite

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Test2::Suite
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Test2::Suite
...
The code for this distribution is [hosted at GitHub](https://github.com/Test-More/Test2-Suite).
...
can submit an issue report [via the web](https://github.com/Test-More/Test2-Suite/issues)
).
