...
use Test2::Tools::Compare qw{
    ...
    hash array bag object meta_check number string subset bool
...
Test2::Suite::V1 - The bundle recommended by the Test2 development team.

=head1 DESCRIPTION

This is the big-daddy bundle. This bundle includes the tools and plugins the
Test2 development team thinks should be loaded by default.
...
=head2 RENAMING ON IMPORT
    ...
    use Test2::Suite::V1 ':DEFAULT' '!ok', ok => {-as => 'my_ok'};
...
This will import all the default items, you need to list this if you have other
arguments and still want the defaults.
...
C<-no_pragmas> argument.
    ...
    use Test2::Suite::V1 -no_pragmas => 1;
...
C<-no_pragmas> import arguments:
    ...
    use Test2::Suite::V1 -no_strict => 1;
...
C<-no_warnings> or C<-no_pragmas> import arguments:
    ...
    use Test2::Suite::V1 -no_warnings => 1;
...
not provide a target then C<$CLASS> and C<CLASS()> will not be imported.
    ...
    use Test2::Suite::V1 -target => 'My::Class';
